...
public class DashboardFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		root.findViewById(R.id.home_btn_starred).setOnClickListener(
				new View.OnClickListener() {
					public void onClick(View view) {
						...
						// Launch list of sessions and vendors the user has
						// starred
						startActivity(new Intent(getActivity(),
		...
		// root.findViewById(R.id.home_btn_vendors).setOnClickListener(new
		...
		// if (UIUtils.isHoneycombTablet(getActivity())) {
		// startActivity(new Intent(getActivity(),
		// VendorsMultiPaneActivity.class));
		// } else {
		...
		root.findViewById(R.id.home_btn_about).setOnClickListener(
				new View.OnClickListener() {
					public void onClick(View view) {
						// Launch map of conference venue
						fireTrackerEvent("Map");
						startActivity(new Intent(getActivity(), UIUtils
								.getAboutActivityClass(getActivity())));
					}
				});
		...
		root.findViewById(R.id.home_btn_nfc_share).setOnClickListener(
				new View.OnClickListener() {
					public void onClick(View view) {
						// splicing in tag streamer
						fireTrackerEvent("NFC");
						Intent intent = new Intent(getActivity(),
								ShareViaNFC.class);
						startActivity(intent);
					}
